...
from master.api_export import ExportJobAPIView
from master.api_password_reset import (
...
# === Issue Solving (master arbitrate eskalasi) ===
from master.api_issue_solving import (
    MasterIssueDetailAPIView,
    MasterIssueDecideAPIView,
...
urlpatterns = [
    ...
    path('master/jobs/<int:pk>/export/', ExportJobAPIView.as_view(), name='master_job_export'),
    ...
    path('master/users/<int:pk>/', UserDetailAPIView.as_view(), name='master_user_detail'),
    path('master/users/<int:pk>/activate/', UserActivateAPIView.as_view(), name='master_user_activate'),

    # Issues
    path('master/issues/', MasterIssueListAPIView.as_view(), name='master_issues'),
    path('master/issues/<int:pk>/', MasterIssueDetailAPIView.as_view(), name='master_issue_detail'),
    path('master/issues/<int:pk>/decide/', MasterIssueDecideAPIView.as_view(), name='master_issue_decide'),
    path('master/issues/<int:pk>/comments/', MasterIssueCommentAPIView.as_view(), name='master_issue_comments'),
