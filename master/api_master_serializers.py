...
class DashboardStatsSerializer(serializers.Serializer):
    ...
    Full breakdown: jobs/users/images/issues per status.
    """
    # Jobs
    ...
    # Images (breakdown lengkap per status)
    ...
    images_annotated = serializers.IntegerField()
    images_in_review = serializers.IntegerField()
    images_in_rework = serializers.IntegerField()
    images_finished = serializers.IntegerField()
    images_with_issues = serializers.IntegerField()

    # Issues (breakdown per status + priority)
    total_issues = serializers.IntegerField()
    issues_open = serializers.IntegerField()
    issues_eskalasi = serializers.IntegerField()
    issues_reworking = serializers.IntegerField()
    issues_closed = serializers.IntegerField()
    issues_high_priority = serializers.IntegerField()
